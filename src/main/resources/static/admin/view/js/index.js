...
layui.config({
	...
	var form = layui.form(),
		...
		tab = layui.bodyTab({
			...
			url : "/api/admin/system/getSystemNav" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="images/userface3.jpg"/></div>'+
	...
	$("body").on("click","#unlock",function(){
		if($(this).siblings(".admin-header-lock-input").val() == ''){
			...
			if(hex_md5($(this).siblings(".admin-header-lock-input").val()) == pass){
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['好的'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>单身总动员后台管理系统</p><p>如有任何问题请联系开发商解决</p></div>',
